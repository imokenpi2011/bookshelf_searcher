...
* The following dependency is not known to work with Spring Native: 'JOOQ Access Layer'. As a result, your application may not work as expected.
...
```
$ docker run --rm -p 8080:8080 bookshelf_searcher:0.0.1-SNAPSHOT
```
